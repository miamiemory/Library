...
module.exports = function (eleventyConfig) {
	eleventyConfig.addLiquidShortcode('mapLink', (address, zip) => {
		return 'https://www.google.com/maps/search/?api=1&query=' + encodeURIComponent(address + ' ' + zip);
	});

	eleventyConfig.addLiquidShortcode('telLink', (phone) => {
